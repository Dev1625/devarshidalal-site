...
const PROJECTS = [
  {
    ...
    when: '2025',
    href: '/fund',
    line: 'Twelve company memos, a 186-entry archive of what happens across the sector, and a log of the founders I have talked to.',
  },
  {
...
const SECTIONS = [
  { href: '/fund', title: 'Healthcare', meta: '12 memos, 186 entries, 7 founders' },
